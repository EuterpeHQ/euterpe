...
function Hero() {
  return (
    <div className="flex flex-col-reverse justify-center gap-10 lg:gap-12 md:flex-row md:px-10 lg:px-24">
      <div className="">
        <div className="w-full h-full flex flex-col gap-6 max-w-md">
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-semibold">
            Invest In Your Favourite Artists: Earn Royalties And More.
          </h1>
          ...
          <Button
            className="w-full md:w-fit font-normal text-sm rounded-2xl gap-4"
            size="lg"
            asChild
          >
