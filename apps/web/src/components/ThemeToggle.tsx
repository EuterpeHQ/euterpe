...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-card/65 hover:dark:bg-card"
      ...
      >
        ...
        >
          ...
          />
          <path
            className="fill-current text-foreground dark:bg-card/65"
