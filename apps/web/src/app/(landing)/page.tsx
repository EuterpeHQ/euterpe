  ...
  return (
    <main className="bg-black">
      ...
      <PlumesAI />
         {/* revolutionary */}
         <section
        className="hidden md:block p-2 px-8 my-4 mt-10 border-2  mb-20 h-[400px] cursor-pointer"
        style={{
      ...
      <footer className="bg-black">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              <h2 className="font-aeonik mb-6 text-sm font-semibold text-primary uppercase ">
                Explore
              </h2>
              <ul className="text-white font-thin text-md">
                <li className="mb-4">
