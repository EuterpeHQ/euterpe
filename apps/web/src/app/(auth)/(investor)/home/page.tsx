  ...
  return (
    <main>
      <div className="max-w-9xl mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
        <Dashboard/>
        <section className="flex flex-col md:flex-row gap-y-4 gap-x-2 justify-between items-center mt-8 w-full">
          <div className="w-full md:w-[50%] px-4 py-4  shadow-md rounded-[16px] border-[0.5px] bg-white/[0.02]">
         <TopToken/>
          </div>
          <div className="w-full md:w-[50%]  shadow-md rounded-[16px] border-[0.5px] bg-white/[0.02] px-4 py-7">
          <section className="flex justify-between items-center">
            ...
            <TooltipProvider>
              ...
              <h2 className="cursor-pointer hover:underline flex justify-stary items-center gap-x-2 text-sm text-primary">See all <ChevronRight size={15}/> </h2>
            </section>
              {/* Pie Chart */}
...
function RecentActivity() {
  return (
    <section className="flex-wrap flex gap-x-10 justify-between  mt-10 w-full rounded-lg py-4 shadow-md  shadow-md rounded-[16px] border-[0.5px] bg-white/[0.02] px-4">
