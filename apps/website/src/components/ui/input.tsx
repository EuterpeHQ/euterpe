    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `dark:placeholder-text-neutral-600 duration-400 flex h-10 w-full rounded-md border-0 bg-surface px-3 py-2 text-sm text-black shadow-input  transition file:border-0 
