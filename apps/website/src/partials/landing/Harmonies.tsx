  ...
  return (
    ...
    <aside className="my-10 gap-y-8 flex flex-col md:flex-row justify-between items-center">
      ...
      <div
        ...
        <p className="ms-10 text-white font-semibold text-2xl">Harmonies unlock <br />
        shared benefits for fans.
        </p>
        <p className="ms-10 text-sm text-[#A5A5A5]">Fans share rewards, royalties, and unique benefits linked to their favorite artists using NFTs bound by legal agreements and secure blockchain contracts.</p>
      </div>
      <div
        ...
        <p className="ms-10 text-white font-semibold text-2xl">Plumes scans for 
        millions of Artists.</p>
        <p className="ms-10 text-sm text-[#A5A5A5]">Plumes is a decentralized AI (dAI) that democratizes artists spotlighting and discovery without preferential treatment, giving independent artists a platform to rise and reach dedicated fans.</p>
      </div>
    </aside>
  </section>
  );
